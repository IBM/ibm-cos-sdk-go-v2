...
func GetObjectTagging() {
	...
	fmt.Println("Getting object tagging for bucket:", bucket)

	out, err := cosClient.GetObjectTagging(context.TODO(), &s3.GetObjectTaggingInput{
		Bucket: aws.String(bucket),
	})
	if err != nil {
		fmt.Println("GetObjectTagging error:", err)
		return
	}
