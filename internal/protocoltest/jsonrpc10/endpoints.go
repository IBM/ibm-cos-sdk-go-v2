...
import (
	...
	internalendpoints "github.com/IBM/ibm-cos-sdk-go-v2/internal/protocoltest/jsonrpc10/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_JSON_RPC_10")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "JSON RPC 10", cfg.ConfigSources)
	if found && err == nil {
