...
func GetBucketProtectionConfiguration() {
	...
	fmt.Println("Getting protection configuration for bucket:", bucket)

	out, err := cosClient.GetBucketProtectionConfiguration(context.TODO(), &s3.GetBucketProtectionConfigurationInput{
		Bucket: aws.String(bucket),
	})
	if err != nil {
		fmt.Println("GetBucketProtectionConfiguration error:", err)
		return
	}
