...
import (
	...
	v4Internal "github.com/IBM/ibm-cos-sdk-go-v2/aws/signer/internal/v4"
	internalauth "github.com/IBM/ibm-cos-sdk-go-v2/internal/auth"
...
func (s *SignHTTPRequestMiddleware) HandleFinalize(ctx context.Context, in middleware.FinalizeInput, next middleware.FinalizeHandler) (
	...
	fmt.Printf("Signing request with name %s, region %s, payload hash %s\n", signingName, signingRegion, payloadHash)
