...
import (
	...
	"github.com/IBM/ibm-cos-sdk-go-v2/internal/endpoints"
	internalendpoints "github.com/IBM/ibm-cos-sdk-go-v2/internal/kitchensinktest/internal/endpoints"
...
func (m *ResolveEndpoint) HandleSerialize(ctx context.Context, in middleware.SerializeInput, next middleware.SerializeHandler) (
	...
	if len(awsmiddleware.GetSigningName(ctx)) == 0 {
		...
		if len(signingName) == 0 {
			signingName = "awsjson1kitchensink"
		}
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_AWSJSON1_KITCHEN_SINK")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "awsJson1 kitchen sink", cfg.ConfigSources)
	if found && err == nil {
