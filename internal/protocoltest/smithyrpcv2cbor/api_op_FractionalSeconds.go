...
func (c *Client) addOperationFractionalSecondsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	err = stack.Serialize.Add(&smithyRpcv2cbor_serializeOpFractionalSeconds{}, middleware.After)
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(&smithyRpcv2cbor_deserializeOpFractionalSeconds{}, middleware.After)
	if err != nil {
		return err
	}
