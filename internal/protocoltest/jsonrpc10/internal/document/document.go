...
// github.com/IBM/ibm-cos-sdk-go-v2/internal/protocoltest/jsonrpc10/internal/document.smithyDocument
// is an interface which is used to bind a document type to its service client.
type smithyDocument interface {
	isSmithyDocument()
}

// github.com/IBM/ibm-cos-sdk-go-v2/internal/protocoltest/jsonrpc10/internal/document.Interface
...
// github.com/IBM/ibm-cos-sdk-go-v2/internal/protocoltest/jsonrpc10/internal/document.IsInterface
