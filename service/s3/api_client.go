...
import (
	...
	"github.com/IBM/ibm-cos-sdk-go-v2/aws/defaults"
	...
	internalChecksum "github.com/IBM/ibm-cos-sdk-go-v2/service/internal/checksum"
	...
	s3sharedconfig "github.com/IBM/ibm-cos-sdk-go-v2/service/internal/s3shared/config"
...
func withOperationMetrics(parent context.Context, mp metrics.MeterProvider) (context.Context, error) {
	meter := mp.Meter("github.com/IBM/ibm-cos-sdk-go-v2/service/s3")
	om := &operationMetrics{}
...
func operationTracer(p tracing.TracerProvider) tracing.Tracer {
	return p.Tracer("github.com/IBM/ibm-cos-sdk-go-v2/service/s3")
}
...
func (c *Client) invokeOperation(
	...
	handler := smithyhttp.NewClientHandlerWithOptions(options.HTTPClient, func(o *smithyhttp.ClientHandler) {
		o.Meter = options.MeterProvider.Meter("github.com/IBM/ibm-cos-sdk-go-v2/service/s3")
	})
...
func addRetry(stack *middleware.Stack, o Options) error {
	attempt := retry.NewAttemptMiddleware(o.Retryer, smithyhttp.RequestCloner, func(m *retry.Attempt) {
		...
		m.OperationMeter = o.MeterProvider.Meter("github.com/IBM/ibm-cos-sdk-go-v2/service/s3")
	})
