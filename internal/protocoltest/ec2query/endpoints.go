...
import (
	...
	internalendpoints "github.com/IBM/ibm-cos-sdk-go-v2/internal/protocoltest/ec2query/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_EC2_PROTOCOL")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "EC2 Protocol", cfg.ConfigSources)
	if found && err == nil {
