...
func (c *Client) addOperationHttpEnumPayloadMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	err = stack.Serialize.Add(&awsRestxml_serializeOpHttpEnumPayload{}, middleware.After)
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(&awsRestxml_deserializeOpHttpEnumPayload{}, middleware.After)
	if err != nil {
		return err
	}
