...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-json-protocol.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-json-protocol.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-json-protocol.dev",
			expectURL:     aws.String("https://env-json-protocol.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-json-protocol.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-json-protocol.dev",
			expectURL:     aws.String("http://config-json-protocol.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-json-protocol.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-json-protocol.dev",
			clientEndpoint: aws.String("https://client-json-protocol.dev"),
			expectURL:      aws.String("https://client-json-protocol.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_JSON_PROTOCOL", c.envService)
			}
