...
func TestClient_NoInputOutput_smithyRpcv2cborSerialize(t *testing.T) {
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.NoInputOutput(context.Background(), c.Params, func(options *Options) {
...
func TestClient_NoInputOutput_smithyRpcv2cborDeserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			var params NoInputOutputInput
			result, err := client.NoInputOutput(context.Background(), &params)
			if err != nil {
				t.Fatalf("expect nil err, got %v", err)
			}
			if result == nil {
