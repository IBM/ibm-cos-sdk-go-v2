...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-json-rpc-10.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-json-rpc-10.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-json-rpc-10.dev",
			expectURL:     aws.String("https://env-json-rpc-10.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-json-rpc-10.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-json-rpc-10.dev",
			expectURL:     aws.String("http://config-json-rpc-10.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-json-rpc-10.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-json-rpc-10.dev",
			clientEndpoint: aws.String("https://client-json-rpc-10.dev"),
			expectURL:      aws.String("https://client-json-rpc-10.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_JSON_RPC_10", c.envService)
			}
