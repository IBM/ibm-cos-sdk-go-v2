...
import (
	...
	internalendpoints "github.com/IBM/ibm-cos-sdk-go-v2/internal/protocoltest/restxml/internal/endpoints"
...
func resolveBaseEndpoint(cfg aws.Config, o *Options) {
	...
	_, s := os.LookupEnv("AWS_ENDPOINT_URL_REST_XML_PROTOCOL")

	if g && !s {
		return
	}

	value, found, err := internalConfig.ResolveServiceBaseEndpoint(context.Background(), "Rest Xml Protocol", cfg.ConfigSources)
	if found && err == nil {
