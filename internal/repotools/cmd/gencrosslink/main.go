...
` + mapping + `        };
        ...
        if (docId === null || operation === null) {
            window.location = 'https://pkg.go.dev/github.com/IBM/ibm-cos-sdk-go-v2';
            return;
        }
		...
		window.location = 'https://pkg.go.dev/github.com/IBM/ibm-cos-sdk-go-v2/service/' + service + '#Client.' + operation;
		})();
    </script>
</html>`
