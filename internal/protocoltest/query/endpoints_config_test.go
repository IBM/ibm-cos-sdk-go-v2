...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-query-protocol.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-query-protocol.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-query-protocol.dev",
			expectURL:     aws.String("https://env-query-protocol.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-query-protocol.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-query-protocol.dev",
			expectURL:     aws.String("http://config-query-protocol.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-query-protocol.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-query-protocol.dev",
			clientEndpoint: aws.String("https://client-query-protocol.dev"),
			expectURL:      aws.String("https://client-query-protocol.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_QUERY_PROTOCOL", c.envService)
			}
