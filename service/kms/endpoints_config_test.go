...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-kms.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kms.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kms.dev",
			expectURL:     aws.String("https://env-kms.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-kms.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-kms.dev",
			expectURL:     aws.String("http://config-kms.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-kms.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-kms.dev",
			clientEndpoint: aws.String("https://client-kms.dev"),
			expectURL:      aws.String("https://client-kms.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_KMS", c.envService)
			}
