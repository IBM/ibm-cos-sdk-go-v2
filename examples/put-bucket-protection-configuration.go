...
func PutBucketProtectionConfiguration() {
	...
	fmt.Println("Setting protection configuration for bucket:", bucket)

	out, err := cosClient.PutBucketProtectionConfiguration(context.TODO(), &s3.PutBucketProtectionConfigurationInput{
		Bucket: aws.String(bucket),
	})
	if err != nil {
		fmt.Println("PutBucketProtectionConfiguration error:", err)
		return
	}
