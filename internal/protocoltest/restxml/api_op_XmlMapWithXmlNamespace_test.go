...
func TestClient_XmlMapWithXmlNamespace_awsRestxmlSerialize(t *testing.T) {
	cases := map[string]struct {
		...
		"RestXmlXmlMapWithXmlNamespace": {
			...
			ExpectMethod:  "POST",
			ExpectURIPath: "/XmlMapWithXmlNamespace",
			ExpectQuery:   []smithytesting.QueryItem{},
			ExpectHeader: http.Header{
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			result, err := client.XmlMapWithXmlNamespace(context.Background(), c.Params, func(options *Options) {
...
func TestClient_XmlMapWithXmlNamespace_awsRestxmlDeserialize(t *testing.T) {
	cases := map[string]struct {
		StatusCode    int
		Header        http.Header
		BodyMediaType string
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			var params XmlMapWithXmlNamespaceInput
			result, err := client.XmlMapWithXmlNamespace(context.Background(), &params)
			if err != nil {
				t.Fatalf("expect nil err, got %v", err)
			}
			if result == nil {
