...
func (c *Client) addOperationPutWithContentEncodingMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	err = stack.Serialize.Add(&awsRestxml_serializeOpPutWithContentEncoding{}, middleware.After)
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(&awsRestxml_deserializeOpPutWithContentEncoding{}, middleware.After)
	if err != nil {
		return err
	}
