...
func TestResolveBaseEndpoint(t *testing.T) {
	cases := map[string]struct {
		...
		"env ignore": {
			...
			envService:    "https://env-rest-xml-protocol-namespace.dev",
			envIgnore:     true,
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rest-xml-protocol-namespace.dev",
			expectURL:     nil,
		},
		"env global": {
			envGlobal:     "https://env-global.dev",
		...
		"env service": {
			...
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rest-xml-protocol-namespace.dev",
			expectURL:     aws.String("https://env-rest-xml-protocol-namespace.dev"),
		},
		"config ignore": {
			envGlobal:     "https://env-global.dev",
			envService:    "https://env-rest-xml-protocol-namespace.dev",
		...
		"config service": {
			configGlobal:  "http://config-global.dev",
			configService: "http://config-rest-xml-protocol-namespace.dev",
			expectURL:     aws.String("http://config-rest-xml-protocol-namespace.dev"),
		},
		"client": {
			envGlobal:      "https://env-global.dev",
			envService:     "https://env-rest-xml-protocol-namespace.dev",
			configGlobal:   "http://config-global.dev",
			configService:  "http://config-rest-xml-protocol-namespace.dev",
			clientEndpoint: aws.String("https://client-rest-xml-protocol-namespace.dev"),
			expectURL:      aws.String("https://client-rest-xml-protocol-namespace.dev"),
		},
	}
	...
	for name, c := range cases {
		t.Run(name, func(t *testing.T) {
			...
			if c.envService != "" {
				t.Setenv("AWS_ENDPOINT_URL_REST_XML_PROTOCOL_NAMESPACE", c.envService)
			}
