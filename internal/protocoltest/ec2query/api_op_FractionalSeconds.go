...
func (c *Client) addOperationFractionalSecondsMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	err = stack.Serialize.Add(&awsEc2query_serializeOpFractionalSeconds{}, middleware.After)
	if err != nil {
		return err
	}
	err = stack.Deserialize.Add(&awsEc2query_deserializeOpFractionalSeconds{}, middleware.After)
	if err != nil {
		return err
	}
