...
const ServiceID = "awsJson1 kitchen sink"
const ServiceAPIVersion = "2025-03-01"
...
func withOperationMetrics(parent context.Context, mp metrics.MeterProvider) (context.Context, error) {
	meter := mp.Meter("github.com/IBM/ibm-cos-sdk-go-v2/internal/kitchensinktest")
	om := &operationMetrics{}
...
func operationTracer(p tracing.TracerProvider) tracing.Tracer {
	return p.Tracer("github.com/IBM/ibm-cos-sdk-go-v2/internal/kitchensinktest")
}
...
func (c *Client) invokeOperation(
	...
	handler := smithyhttp.NewClientHandlerWithOptions(options.HTTPClient, func(o *smithyhttp.ClientHandler) {
		o.Meter = options.MeterProvider.Meter("github.com/IBM/ibm-cos-sdk-go-v2/internal/kitchensinktest")
	})
...
func addClientUserAgent(stack *middleware.Stack, options Options) error {
	...
	ua.AddSDKAgentKeyValue(awsmiddleware.APIMetadata, "awsjson1kitchensink", goModuleVersion)
...
func addRetry(stack *middleware.Stack, o Options) error {
	attempt := retry.NewAttemptMiddleware(o.Retryer, smithyhttp.RequestCloner, func(m *retry.Attempt) {
		...
		m.OperationMeter = o.MeterProvider.Meter("github.com/IBM/ibm-cos-sdk-go-v2/internal/kitchensinktest")
	})
